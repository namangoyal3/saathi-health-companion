...
TTS_STRINGS: dict[str, dict[str, str]] = {
    "ta": {
        "flowA_prompt": (
            "வணக்கம்! நீங்கள் உங்கள் மருந்தை எடுத்தீர்களா? "
            "எடுத்திருந்தால் 1 ஐ அழுத்தவும், தவிர்க்க 2 ஐ அழுத்தவும்."
        ),
        "flowA_repeat": (
            "மருந்து எடுத்திருந்தால் 1 ஐ அழுத்தவும்."
        ),
        ...
        "flowC_symptom": (
            "எந்த அறிகுறி உள்ளது? தலைவலி 1, வயிற்று வலி 2, "
            "தலைசுற்றல் 3, வேறு 4 ஐ அழுத்தவும்."
        ),
        "flowC_symptom_options": "உங்கள் அறிகுறியை தேர்ந்தெடுக்கவும்.",
    },
    "hi": {
        "flowA_prompt": (
            "नमस्ते! क्या आपने अपनी दवाई ली? "
            "हाँ तो 1 दबाएं, छोड़ना है तो 2 दबाएं।"
        ),
        ...
        "flowB_urgent": (
            "तत्काल सूचना! कृपया अभी अपनी दवाई लें। "
            "आपके परिवार को सूचित किया गया है। "
            "सहायता के लिए 1 दबाएं।"
        ),
        "flowB_repeat": "सहायता के लिए 1 दबाएं।",
        "flowC_greeting": (
            "नमस्ते! आज आप कैसे हैं? "
            "अच्छे हैं तो 1, कोई तकलीफ है तो 2, "
            "डॉक्टर से बात करनी है तो 3 दबाएं।"
        ),
        "flowC_options": "अच्छे हैं तो 1, तकलीफ है तो 2 दबाएं।",
        "flowC_symptom": (
            "क्या तकलीफ है? सिरदर्द 1, पेटदर्द 2, "
            "चक्कर आना 3, कुछ और 4 दबाएं।"
        ),
        "flowC_symptom_options": "अपनी तकलीफ चुनें।",
    },
    "en": {
        "flowA_prompt": (
            "Hello! Did you take your medication? "
            "Press 1 for yes, press 2 to skip."
        ),
...
def render_flow_c_symptom(call_id: str, language: str, webhook_base: str) -> str:
    ...
    return _FLOW_C_SYMPTOM_TEMPLATE.render(
        ...
        symptom_options_url=get_tts_url(strings["flowC_symptom_options"], language, call_id=call_id),
        no_input_url=get_tts_url(strings["flowA_no_input"], language, call_id=call_id),
    )
